...
$conn=mysqli_connect($servername,$username,$password,$database);
    $sql="INSERT INTO `studentsdata`(`Aadhar`, `Name`, `Age`, `School Before Dropping Out`, `Class Dropped`, `Year Dropped`, `Gender`) VALUES ('$aadhar','$name','$age','$school','$class','$year','$gender')";
...
<main>
    ...
    <p></p>
    <form action="conseller.php" method="post">
    <div class="insertvalues" id="insertvaluesid">
        <div>Aadhar &ensp;<input type="text" id="txtst" placeholder="enter aadhar number" name="aadhar"></div>
        <div>Name &ensp;<input type="text" id="txtyear" placeholder="enter name" name="name"></div>
        <div>age &ensp;<input type="text" id="txtstudents" placeholder="enter age" name="age"></div>
        <div>Schools &ensp;<input type="text" id="txtschools" placeholder="enter total no. of schools" name="school"></div>
        <div>class dropped &ensp;<input type="text" id="txtdrop" placeholder="enter class" name="class"></div>
        <div>year dropped &ensp;<input type="text" id="txtliteracy" placeholder="enter year" name="year"></div>
        <div> Gender&ensp;<input type="text" id="txtgender" placeholder="enter gender" name="gender"></div>
            ...
            <table id="tableID" class="display" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>name</th>
                        <th>age</th>
                        <th>school studied before dropping out</th>
                        <th>class dropped</th>
                        <th>year dropped</th>
                        <th>Gender</th>
...
if ($result = $mysqli->query($query)) {
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        <tr>
        <td id="checkbox_a" class="inner_checkbox">
        <div><button type="button" id="checkbox_appearer"><a href="delete_student.php?id=<?php echo $row["Aadhar"]; ?>">delete</a></button></div>
    </td>
        <td><?php echo $row["Aadhar"]; ?></td>
        <td><?php echo $row["Name"]; ?></td>
        <td><?php echo $row["Age"]; ?></td>
        <td><?php echo $row["School Before Dropping Out"]; ?></td>
        <td><?php echo $row["Class Dropped"]; ?></td>
        <td><?php echo $row["Year Dropped"]; ?></td>
...
?> 
                    ...
                    <tr>
                        ...
                        <td> 1234 5678 9876 9884 </td>
                        <td>bhav</td>
                        <td>13</td>
                        <td>ghsv tamil nadu</td>
                        <td>8th</td>
                        <td>2015</td>
                        <td>M</td>
                    </tr>
                    <tr>
                        ...
                        <td> 1234 5678 9876 9885 </td>
                        <td>bhavani</td>
                        <td>16</td>
                        <td>ghsvm tamilnadu</td>
                        <td>8th</td>
                        <td>2015</td>
                        <td>F</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td> 1234 5678 9876 9888 </td>
                        <td>bhert</td>
                        <td>16</td>
                        <td>ghsv arunachal</td>
                        <td>6th,8th</td>
                        <td>2017,2019</td>
                        <td>M</td>
                    </tr>
