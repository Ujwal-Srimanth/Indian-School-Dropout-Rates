...
$conn=mysqli_connect($servername,$username,$password,$database);
    ...
    $sql= "INSERT INTO `askadoubt` (`question`, `what have u tried`) VALUES ('$email', '$password1 ')";
...
<style>
    ...
    .insider{
        ...
        box-shadow: 1rem 1rem 1rem rgb(129, 109, 109);
        border-radius: 20px;
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="askdoubt.php" class="active">
                    <span class="material-icons-sharp">grid_view</span>
                    <h3>Ask doubt</h3>
        ...
        <main>
            ...
            <div class="insider">
                <form action="askdoubt.php" method="POST">
                    Enter question:<br>
                    <input type="text" class="question" placeholder="ask your query here" style="height: 50px;border-radius: 5px;" name="question">
                    Enter What have you tried here:
                    <textarea rows="15" cols="60" placeholder="Enter what have you tried here" name="what"></textarea>
                    <input type="submit" onclick = "rr()"value="submit" style="background-color: rgb(67, 220, 67);color: white;border-radius:10px ;margin-top: 10px;padding: 20px;">
                    <script>function rr(){window.alert("your request has been submitted")}</script>
                </form>
            </div>
