...
$conn=mysqli_connect($servername,$username,$password,$database);
    $sql= "INSERT INTO `studentsdata` (`id`, `name`,`location`,`address`) VALUES ('$id', '$name','$location','$address')";
...
<body>
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <a href="conseller.html">
                <span class="material-icons-sharp">grid_view</span>
                <h3>student_data</h3>

            </a>
            <a href="studentsdata.html" class="active">
                <span class="material-icons-sharp">grid_view</span>
...
<main>
    ...
    <div class="insertvalues" id="insertvaluesid">
        ...
        <div>location &ensp;<input type="text" id="txtstudents" placeholder="enter location" name="location"></div>
...
?>
<?php $query="SELECT * FROM studentsdata WHERE ID=121212" ?>
<?php
$username = "root"; 
$password = ""; 
$database = "project1"; 
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr>
        <td id="checkbox_a" class="inner_checkbox">
        <div><input type="button" id="checkbox_appearer"></div>
    </td>
                  <td>'.$field1name.'</td> 
                  <td>'.$field2name.'</td> 
                  <td>'.$field3name.'</td> 
